    ...
    <div class="card-header">
      <span class="card-title"><?php  echo $title; ?></span>
       <div class="pull-right error_msg">
          <a href="<?php echo base_url(); ?>Subscription_panel/add" class="btn btn-success" data-toggle="tooltip" title="New complaint"><i class="fa fa-plus"></i></a>
          ...
          $i=1;foreach($subscriptions as $obj){ ?>
            ...
            <tr>
                ...
                <td>
                  ...
                  <a class="btn btn-xs btn-primary btnEdit" href="<?php echo base_url(); ?>Subscription_panel/edit/<?php echo $obj['id'];?>"><i class="fa fa-edit"></i></a>
                ...
                <!-- Model for details -->
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 ">
                                 ...
                                 <div class="col-md-12 col-sm-12 ">
                                    ...
                                    <span><?php echo $obj['duration']; ?></span>
                                </div>
                              </div>
                  ...
                  <!-- Model for Delete -->
                    <div class="modal fade" id="delete<?php echo $obj['id'];?>" role="dialog">
                      <div class="modal-dialog">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Subscription_panel/deleteRecord/<?php echo $obj['id'];?>">
                        <!-- Modal content-->
                        <div class="modal-content">
                          <div class="modal-header">
  ...
  $( document ).ready(function() {
    ...
    {  
      ...
      if(check == true){  
        ...
        $.ajax({   
          type: "POST",  
          url: "<?php echo base_url(); ?>Subscription_panel/deleteRecord",  
          cache:false,  
