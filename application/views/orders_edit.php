					...
					<div class="form-container">
						<div class="row">
							<div class="form-group col-md-4">
								...
								<input type="text" name="order_date" data-date-formate="dd-mm-yyyy" class="form-control date-picker" value="<?php echo date('d-m-Y',strtotime($current['0']['order_date'])); ?>" placeholder="dd-mm-yyyy" autofocus autocomplete="off">
							</div>
							<div class="form-group col-md-4">
								<label> Order ID </label>
								<input type="text" name="order_id" value="<?= $current['0']['order_id']; ?>" class="form-control" placeholder="Order ID" disabled>
							</div>
							<div class="form-group col-md-4">
								<label> User ID </label>
								<?php echo form_dropdown('user_id', $users, $current['0']['user_id']) ?> 
							</div>
						<div class="form-group col-md-4">
							...
							<select class="form-control " name="subscription_plan_id" id="subscription_plan_id">
								...
								<option value="<?php echo $value['id']; ?>" price="<?php echo $value['price']?>" <?php if($current['0']['subscription_plan_id']==$value['id']) { echo "selected";} ?>> 
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="amount" class="form-control amount" value="<?= $current['0']['plan_price']; ?>" readonly="readonly" placeholder="Subscription Plan Amount">
							</div>
							<div class="form-group col-md-4">
								<label> Payment Flow </label>
								<select class="form-control payment_flow" name="plan_status" aria-label="Default select example">
									<option <?php if($current['0']['plan_status']=="1"){ echo "selected";} ?> value="1">Monthly</option>
									<option <?php if($current['0']['plan_status']=="12"){ echo "selected";} ?> value="12" >Yearly</option>
								</select>	
							</div>
							<div class="form-group col-md-4">
								<label> Total </label>
								<input type="text" name="plan_total" class="form-control plan_total" value="<?= $current['0']['amount'] ?>" placeholder="Plan Total" readonly="readonly">
							</div>							
							<div class="form-group col-md-4">
								<label> Payment Terms </label>
								<input type="text" name="payment_terms" class="form-control" value="<?= $current['0']['payment_terms'] ?>" placeholder="Payment Terms">
							</div>
							<div class="form-group col-md-4">
								...
								<select class="form-control form-select" name="payment_status" aria-label="Default select example">
									<option <?php if($current['0']['payment_status']=="1"){ echo "selected";} ?> value="1">Pending</option>
									<option <?php if($current['0']['payment_status']=="2"){ echo "selected";} ?> value="2">Success</option>
								</select>	
							</div>
						</div>
						<hr>
							...
							<div class="row col-md-12">
				        		<div class="table-responsive">
					        		<table class="table table-bordered " id="maintable" >
					        			...
					        			<tbody id="mainbody">
										<?php $i=1; foreach($current['0']['order_details'] as $order_addons) { ?>
			        						<tr class="main_tr1">
												<td><?php echo $i; ?></td>
												<td> 
													<select class="form-control addon_service_id" name="addon_service_id[]">
														...
														<option <?php if($value['id']==$order_addons['addon_service_id']) { echo "selected";} ?> value="<?php echo $value['id']; ?>" price="<?php echo $value['price']?>" >
															<?php echo $value['title']?>
														</option>
														<?php } ?>
													</select>
												...
												<td> 
													<input type="text" name="price[]" value="<?php echo $order_addons['price']; ?>" class="form-control price" placeholder="Price" style="margin-bottom: 5px;" readonly="readonly"> 
												</td>
												<td> 
													<input type="text" name="qty[]" value="<?php echo $order_addons['qty']; ?>" class="form-control qty" placeholder="Enter Qty" style="margin-bottom: 5px;"> 
												</td>
												<td> 
													<input readonly type="text" name="amount[]" value="<?php echo $order_addons['total']; ?>" class="form-control total_amt_addon" placeholder="Amount" style="margin-bottom: 5px;"> 
												</td>
												<td >
										...
										<tfoot>
											<tr>
												...
												<td ><input readonly type="text" name="grand_total" class="form-control grand_total" value="<?php echo $current['0']['grand_total']; ?>" placeholder="Grand Amount" style="margin-bottom: 5px;"> </td>
												<td></td>
											</tr>
										</tfoot>
					        		</table>
...
<script>
	<?php if(!empty($current['0']['order_details'])) { ?>
		$('.box_addon').addClass('show');
	<?php } else { ?>
