        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <thead>
            <tr>
              ...
              <th style="white-space: nowrap;"> Cart ID </th>
          ...
          <tbody>
           ...
           <?php
          $i=1;foreach($cart as $obj){ ?>

            <tr>
                <td><input type="checkbox" class="sub_chk" value="<?php echo $obj['id']; ?>" /></td>
                <td><?php echo $i;?></td>
                <td><?php echo $obj['date']; ?></td>
                <td><?php echo $obj['cart_id']; ?></td>
                ...
                <td>
                  ...
                  <a class="btn btn-xs btn-primary btnEdit" href="<?php echo base_url(); ?>Orders_panel/cart_edit/<?php echo $obj['id'];?>"><i class="fa fa-edit"></i></a>
                  ...
                  <div class="modal fade" id="view<?php echo $obj['id'];?>" role="dialog">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-md-4">
                                      ...
                                      <span><?php echo $obj['date']; ?></span>
                                  </div>
                                  <div class="col-md-4">
                                      <label class="control-label"> Cart ID : </label>
                                      <span><?php echo $obj['cart_id']; ?></span>
                                  </div>
                                  <div class="col-md-4">
                    ...
                    <div class="modal fade" id="delete<?php echo $obj['id'];?>" role="dialog">
                        <div class="modal-dialog">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Orders_panel/cartDelete/<?php echo $obj['id'];?>">
                                <!-- Modal content-->
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <p>Are you sure, you want to delete order <b><?php echo $obj['cart_id'];?> </b>? </p>
                                    </div>
                                    <div class="modal-footer">
