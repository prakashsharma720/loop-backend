...
<div class="container-fluid">
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
                <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Orders_panel/update_addon_service_record/<?php echo $id; ?>">
					<div class="form-container">
						<div class="row">
							<div class="form-group col-md-4">
								<label> Order Date </label>
								<input type="text" name="order_date" data-date-formate="dd-mm-yyyy" class="form-control date-picker" value="<?php echo date('d-m-Y',strtotime($current->order_date)); ?>" placeholder="dd-mm-yyyy" autofocus autocomplete="off">
							</div>
							<div class="form-group col-md-4">
								<label> User ID </label>
								<?php echo form_dropdown('user_id', $users, $current->user_id) ?> 
							</div>
							<div class="form-group col-md-4">
								...
								<select class="form-control " name="addon_service_id" id="addon_service_id">
									...
									<?php  foreach ($addonservices as $key => $value) { ?> 
										<option value="<?php echo $value['id']; ?>" price="<?php echo $value['price']?>" <?php if($current->addon_service_id==$value['id']) { echo "selected";} ?>>
							...
							<div class="form-group col-md-4">
								...
								<input type="text" name="plan_price" class="form-control amount" value="<?php echo $current->price; ?>" readonly="readonly" placeholder="Addon Service Amount">
							</div>
							<div class="form-group col-md-4">
								<label name="qty"> Qty </label>
								<input type="text" name="qty" class="form-control qty" value="<?php echo $current->qty; ?>" placeholder="Addon Service Qty">
							</div>
							<div class="form-group col-md-4">
								<label> Total </label>
								<input type="text" name="plan_total" class="form-control plan_total" value="<?php echo $current->grand_total; ?>" placeholder="Grand Total" readonly="readonly">
							</div>							
							<div class="form-group col-md-4">
								<label> Payment Terms </label>
								<input type="text" name="payment_terms" class="form-control" value="<?php echo $current->payment_terms; ?>" placeholder="Payment Terms">
							</div>
							<div class="form-group col-md-4">
