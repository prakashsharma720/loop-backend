...
<div class="container-fluid">
    ...
    <div class="card card-primary card-outline">
        ...
        <div class="card-body">
                ...
                <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>Subscription_panel/add_new_record">
					<div class="form-container">
						<div class="row">
							<div class="form-group col-md-6">
								<label> Title </label><span class="required">*</span>
								<input type="text" name="title" class="form-control" placeholder="Enter Plan Title">
							</div>
							<div class="form-group col-md-6">
								<label> Price </label><span class="required">*</span>
								<input type="text" name="price" class="form-control" placeholder="Price" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');" required="required">
							</div>
							<div class="form-group col-md-6">
