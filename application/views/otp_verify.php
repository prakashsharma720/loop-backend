  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      >
        ...
        <?php if(@$success_mesg):?>
          <div style="background-color: #1295AB;color: #f8f9fa; width: 100%; padding: 10px; margin-bottom: 10px; padding-left: 10px;" class="error_mesg"><?php echo @$success_mesg; ?>
     ...
     <?php if(@$error_message):?>
      ...
      <form action="<?php echo base_url() ;?>User_authentication/otpVerify" method="post">
